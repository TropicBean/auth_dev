/* maauthsavhisttt.i MEDSTAR Medical Aid System
...
&IF DEFINED(TEMP-TABLE-NAME) = 0 &THEN
  &SCOPED-DEFINE TEMP-TABLE-NAME tt_auth_savings_history
&ENDIF
...
DEFINE {&ACCESS} TEMP-TABLE {&TEMP-TABLE-NAME} NO-UNDO {&REFERENCE-ONLY}
  ...
  FIELD auth_savings_history_obj            AS DECIMAL         FORMAT ">>>>>>>>>>>>>>>>>9.999999"
  FIELD auth_savings_obj                    AS DECIMAL         FORMAT ">>>>>>>>>>>>>>>>>9.999999"
  ...
  FIELD saving_status                       AS INTEGER         FORMAT "9"
  ...
  INDEX xPK_hah_auth_mc_savings_history AS PRIMARY UNIQUE
    auth_savings_history_obj
    .
