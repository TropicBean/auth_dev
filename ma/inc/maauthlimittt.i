/* maauthlimittt.i MEDSTAR Medical Aid System
...
&IF DEFINED(TEMP-TABLE-NAME) = 0 &THEN
  &SCOPED-DEFINE TEMP-TABLE-NAME tt_auth_limit
&ENDIF
...
DEFINE {&ACCESS} TEMP-TABLE {&TEMP-TABLE-NAME} NO-UNDO {&REFERENCE-ONLY}
  ...
  INDEX xPK_hat_auth_limit AS PRIMARY UNIQUE
    auth_limit_obj
    
  INDEX xAK1_hat_auth_limit
    auth_obj
    effective_date
    claim_code
    claim_type
