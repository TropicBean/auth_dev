/*
   ...
   This program has been replaced with maauthmcsavingstt.i.


/* maauthsavingstt.i MEDSTAR Medical Aid System
...
&IF DEFINED(TEMP-TABLE-NAME) = 0 &THEN
  &SCOPED-DEFINE TEMP-TABLE-NAME tt_auth_savings
&ENDIF
...
DEFINE {&ACCESS} TEMP-TABLE {&TEMP-TABLE-NAME} NO-UNDO {&REFERENCE-ONLY}
  ...
  INDEX xPK_hat_auth_savings AS PRIMARY UNIQUE
    auth_savings_obj
    .
*/
