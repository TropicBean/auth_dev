...
DEFINE {&ACCESS} TEMP-TABLE {&TEMP-TABLE-NAME} NO-UNDO {&REFERENCE-ONLY}
  ...
  FIELD _apply_line_restrict_rules          AS LOGICAL INITIAL TRUE  FORMAT "yes/no"
  FIELD _ars_rate                           AS CHARACTER             FORMAT "x(20)"
  FIELD _ars_rate_upd_allowed               AS LOGICAL               FORMAT "yes/no"
  FIELD _auth_group_updated                 AS LOGICAL               FORMAT "yes/no"
  ...
  FIELD _loc_tariff_type_category           AS CHARACTER             FORMAT "x(20)"
