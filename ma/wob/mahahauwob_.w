...
DEFINE VARIABLE gcEntities              AS CHARACTER          NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN 
    ...
    gcEntityList        = IF get-value("EntityList") = "":U 
                          THEN "hahau,hahap,hahac,hahad,hahcw,hahcp,hahal,hahep":U
...
------------------------------------------------------------------------------*/
  ...
  CASE gclsWob:Mode:
    ...
    END. // WHEN "VIEW-ALL":U
    WHEN "VIEW-SINGLE":U THEN
    DO:



    END. // WHEN "VIEW-SINGLE":U

  END CASE.
  IF gclsWob:Mode = "VIEW-ALL":U THEN
  DO:

  END. // IF  gclsWob:Mode = "VIEW-ALL" THEN
...
------------------------------------------------------------------------------*/  
  ...
  ASSIGN 
    cContainerCode         = "AuthLimitHistory":U 
    oContainer             = NEW cls.mipwscontainer(cContainerCode, "100%":U, " Auth Limit History":U, WarpSpeed:BaseClass, TRUE)
    oContainer:QueryString = "FOR EACH tt_auth_limit_history ":U 
    oControl               = oContainer:addControl("fcAction":U               + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.action":U                 , "CHARACTER":U , 1  , "Action":U )
    oControl               = oContainer:addControl("fcChangeUserID":U         + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.change_usr_id":U          , "CHARACTER":U , 2  , "Change User ID":U )
    oControl               = oContainer:addControl("fcChangeDateTime":U       + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.change_date_time":U       , "DATETIME":U  , 3  , "Change Date Time":U )
    oControl               = oContainer:addControl("fcAuthLimitObj":U         + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.auth_limit_obj":U         , "DECIMAL":U   , 6  , "Auth Limit Obj":U )
    oControl               = oContainer:addControl("fcClaimCode":U            + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.claim_code":U             , "INTEGER":U   , 7  , "Claim Code":U )
    oControl               = oContainer:addControl("fcClaimType":U            + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.claim_type":U             , "CHARACTER":U , 8  , "Claim Type":U )
    oControl               = oContainer:addControl("fcFetchDateTime":U        + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.fetch_date_time":U        , "DATETIME":U  , 11 , "Fetch Date Time":U )
    oControl               = oContainer:addControl("fcLimit#":U               + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.limit_#":U                , "INTEGER":U   , 12 , "Limit #":U )
    oControl               = oContainer:addControl("fcLimitAvail":U           + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.limit_avail":U            , "DECIMAL":U   , 13 , "Limit Avail":U )
    oControl               = oContainer:addControl("fcDependant":U            + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.dependant":U              , "INTEGER":U   , 14 , "Dependant":U )
    oControl               = oContainer:addControl("fcLimitReserved":U        + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.limit_reserved":U         , "DECIMAL":U   , 15 , "Limit Reserved":U )
    oControl               = oContainer:addControl("fcLimitUsed":U            + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.limit_used":U             , "DECIMAL":U   , 16 , "Limit Used":U )
    oControl               = oContainer:addControl("fcOwningEntityMnemonic":U + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.owning_entity_mnemonic":U , "CHARACTER":U , 17 , "Owning Entity Mnemonic":U )
    oControl               = oContainer:addControl("fcOwningAltValue":U       + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.owning_alt_value":U       , "CHARACTER":U , 19 , "Owning Alt Value":U )
    oControl               = oContainer:addControl("fcEffectiveDate":U        + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.effective_date":U         , "DATE":U      , 20 , "Effective Date":U )
    oControl               = oContainer:addControl("fcSequence":U             + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.sequence":U               , "INTEGER":U   , 21 , "Sequence":U )
    oControl               = oContainer:addControl("fcOptionCode":U           + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.option_code":U            , "INTEGER":U   , 22 , "Option Code":U )
    oControl               = oContainer:addControl("fcRatePer":U              + cContainerCode , "wsInput":U , "10":U , "tt_auth_limit_history.rate_per":U               , "CHARACTER":U , 23 , "Rate Per":U )
  .
*/
  { mip/inc/mipcatcherror.i }
