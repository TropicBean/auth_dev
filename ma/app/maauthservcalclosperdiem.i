/* maauthservcalclosperdiem.i  MEDSTAR Medical Aid System
...
&IF {&DBDFMA} >= 010195 &THEN
  ...
  DO:
    ...
    ASSIGN
      ...
      cTrackingMessage = "calcLOSPerDiem {&DetailBuffer}.end_date/time=" + STRING({&DetailBuffer}.end_date,"99/99/99") + 
