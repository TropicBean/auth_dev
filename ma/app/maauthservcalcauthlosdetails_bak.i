...
&IF {&DBDFMA} >= 010195 &THEN
  ...
  ASSIGN
      ...
      cMessage  = "LOS/LOC could not be calculated for [ Ars Rate:[ARSRATE] LOC:[LOC] ]' because ARS & LOC set up is missing":U.
                       ...
                       NOT AVAILABLE buf_auth_detail OR
                          (AVAILABLE buf_auth_detail AND
                                    (buf_auth_detail.owning_obj   <> btt_auth_detail.owning_obj   OR
                                     ...
                                     buf_auth_detail.loc_sequence <> btt_auth_detail.loc_sequence)).
    ...
    */
    ...
    DO:
      ...
      FOR EACH  btt_auth_detail EXCLUSIVE-LOCK
        ...
        IF lValidDefaultLineRestriction THEN
        ...
        DO:
          ...
          ASSIGN btt_auth_detail.record_action = "":U
                 btt_auth_detail.discount_type = ?.    /* TODO - How do we populate this for LOS/LOC??? */
          ...
          IF btt_auth_detail.tariff_type_obj = 0.00 THEN
          DO:
            ...
            THEN
              ASSIGN btt_auth_detail.tariff_type_obj = tt_tariff_type_link.tariff_type_obj.

          END. /*IF btt_auth_detail.tariff_type_obj = 0.00 THEN*/

          /* Populate loc_value/tariff type code if not populated */
          IF btt_auth_detail.loc_value = "":U AND btt_auth_detail.tariff_type_obj <> 0.00 THEN
          DO:

             /* Find tariff type required to populate loc value if not populated */
             oTariffType:focusTariffType(INPUT btt_auth_detail.tariff_type_obj).
          ...
          END. /*IF btt_auth_detail.loc_value = "":U AND btt_auth_detail.tariff_type_obj <> 0.00 THEN*/
          ...
          DO:
            ...
            DO:
              oErrorObject:addError (INPUT "LOS":U,
                                     ...
                                     INPUT REPLACE(REPLACE(cMessage, "[LOC]":U, btt_auth_detail.loc_value), "[ARSRATE]":U, cArsRate),
                                     INPUT "ERR":U).
      ...
      */                                
      ...
      THEN DO:
        ...
        */
        mipEnv:Health:AuthService:getAuthTypeConfig (INPUT btt_auth.auth_type_obj,                 /* ipdAuthTypeObj   */
                                                     ...
                                                     INPUT btt_auth_provider.provider_type,        /* ipcProviderType  */
                                                     INPUT STRING(btt_auth_provider.pr_type),      /* ipcDiscipline    */
                                                     INPUT STRING(btt_auth_provider.sub_pr_type),  /* ipcSubDiscipline */
